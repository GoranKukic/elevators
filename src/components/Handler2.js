...
function Handler2({ setFloorSelectorThirdElevator, resetState }) {
  const onButtonClick = (floor) => {
    setFloorSelectorThirdElevator(floor);
    ...
    setTimeout(() => setFloorSelectorThirdElevator(null), 5000);
  };
  ...
  return (
    <div className="handler handler2">
      <div className="display display2">Stand by</div>
      <div className="inscription">
        <h3>Here you call elevator 3 for all floors</h3>
      </div>
